...
jasmine.Matchers.prototype.toBeTypeOrNull = function(expected) {
  ...
  // Test
  var retVal = (this.actual === null) || (_toType(this.actual) === eType);
  if(!retVal) {
    this.spec.fail(this.message());
  }
  return retVal;
};
jasmine.Matchers.prototype.toBeTypeOrUndefined = function(expected) {
  ...
  // Custom failure message
  this.message = function() {
    return "Expected '" + aType + "' to be type '" + eType + "' or undefined";
  }
  // Test
  var retVal = (this.actual === undefined) || (_toType(this.actual) === eType);
  if(!retVal) {
    this.spec.fail(this.message());
  }
  return retVal;
};
jasmine.Matchers.prototype.toBeTypeOrNullOrUndefined = function(expected) {
  var aType = _toType(this.actual);
  var eType = _toType(expected);
  // Function is not a valid JSON type
  if("function" === eType) {
  ...
  // Custom failure message
  this.message = function() {
    return "Expected '" + aType + "' to be type '" + eType + "' or null or undefined";
  }
  // Test
  var retVal = (this.actual === null) || (this.actual === undefined) || (_toType(this.actual) === eType);
  if(!retVal) {
    this.spec.fail(this.message());
  }
  return retVal;
